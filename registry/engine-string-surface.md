...
**2898** pushed identifier strings. Kinds: tag 1818, unclassified 702, file 304, code 74.

Tag domains (a string may be in more than one): ra2 1474, rules 1390, art 207, map 187, theater 68, ai 31, rmg 16, sound 14, mission 11, mapsel 11, mp 11, coop 5, eva 5, theme 4, battle 4.

Full data in `engine-string-surface.csv` / `.json`. Rules tags also have a cleaner, cross-linked view in `vanilla-tags.md` (Phase D).

## Unclassified — candidate undocumented tags (702)
